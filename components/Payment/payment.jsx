          ...
          <TabList>
            ...
            <Tab>
              <Box>
                ...
                <Box display={"flex"}>
                  <Image src="https://www.licious.in/img/rebranding/offer.svg" alt="offer" />
          ...
          <TabPanels>
            <TabPanel>
              ...
              <Box display={"flex"} mb={"15px"}>
                <Image src="https://www.licious.in/img/rebranding/offer.svg" mt='-15px' alt="offer" />
              ...
              <Box
                ...
                borderRadius={"15px"}
              >
                <Image src="https://d2407na1z3fc0t.cloudfront.net/Banner/paytm.png" alt="Paytm" />
                <Hide below="sm">
              ...
              <Box>
                <Box display={"flex"}>
                  <Box w={"150px"} m={"20px"} border={"1px solid grey"}>
                    <Image src="https://d2407na1z3fc0t.cloudfront.net/Banner/GPay@3x.png" alt="Google Pay" />
                  </Box>
                  <Box w={"150px"} m={"20px"} border={"1px solid grey"}>
                    <Image src="https://d2407na1z3fc0t.cloudfront.net/Banner/PaytmUPI@3xNew.png" alt="Paytm UPI" />
                  </Box>
                </Box>
                <Box display={"flex"}>
                  <Box w={"150px"} m={"20px"} border={"1px solid grey"}>
                    <Image src="https://d2407na1z3fc0t.cloudfront.net/Banner/Phonepe@3x.png" alt="PhonePe" />
                  </Box>

                  <Box w={"150px"} m={"20px"} border={"1px solid grey"}>
                    <Image src="https://d2407na1z3fc0t.cloudfront.net/Banner/More%20UPI@3x.png" alt="More UPI" />
                  </Box>
                </Box>
              </Box>
            </TabPanel>
